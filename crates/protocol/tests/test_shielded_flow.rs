...
mod test_shielded_flow_impl {
    ...
    fn test_shielded_deposit_instruction() {
        ...
        call_protocol::instructions::execute_protocol_instructions(&instructions, &mut balances, &registry, &mut compliance, &mut shielded_state, sender, None, &mut None, None).unwrap();
